...
#define HARDWARE_PROFILE_PIC18F87J50_PIM_H
    ...
    /** SWITCH *********************************************************/
    #define mInitAllSwitches()  TRISEbits.TRISE4=1;
    #define mInitSwitch2()      TRISEbits.TRISE4=1;
    #define mInitSwitch3()      TRISEbits.TRISE4=1;
    #define sw2                 PORTEbits.RE4
    #define sw3                 PORTEbits.RE4
